...
<tr>
	...
	<th rowspan="7"><img src="${contextPath}/resources/poster/${mdto.mov_img}" style="margin-left: 30%;height: 400px"></th>
</tr>
<tr>
...
<tr>
	<td>개봉일 : <fmt:formatDate value="${mdto.mov_regdate}" pattern="yyyy-MM-dd"/></td>
</tr>
<tr>
